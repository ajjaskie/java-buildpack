  ...
  module Framework
    ...
    class ContainerCertificateTrustStore < JavaBuildpack::Component::BaseComponent
      ...
      def compile
        ...
        with_timing("Adding #{resolved_certificates.count} certificates to #{trust_store.relative_path_from(@droplet.root)}") do
      ...
      def ca_certificates
        Pathname.new('etc/ssl/certs/ca-certificates.crt')
      end
